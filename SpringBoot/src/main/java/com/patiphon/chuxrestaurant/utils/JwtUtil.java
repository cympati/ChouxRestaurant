package com.patiphon.chuxrestaurant.utils;
...
public class JwtUtil {
    ...
    private static final Key KEY = Keys.hmacShaKeyFor("qwaeszrdxtfcygvuhbijnokmplmnbvcxzasdfghjklpoiuytrewq".getBytes());
