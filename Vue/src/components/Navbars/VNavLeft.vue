<template>
  <v-navigation-drawer app width="250" style="max-height: 100vh">
    <div style="height: 100%">
      ...
      <v-list shaped>
        <v-list-item-group v-model="selectedItem" color="red">
          <v-list-item class="mt-3" to="/reservation">
            <div class="d-flex justify-space-between">
              <v-icon class="text-decoration-none mr-3">$reservation</v-icon>
              <v-list-item-title
...
.logOut {
  ...
  &:hover {
    background-color: rgba($color: #9f4c38, $alpha: 0.12);
    color: #9f4c38;
    cursor: pointer;
  }
}
